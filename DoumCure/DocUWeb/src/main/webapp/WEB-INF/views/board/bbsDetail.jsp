    ...
    <div class="container bbs-list-container  ">
      <div class="row bbs-content-wrap">
        ...
        <form action="detailForm" method="post" name="detailForm">
          <div class="t-control">
            <div>
              <input class="form-control Large input " id="board-title-sel" name="title" value="건강정보" readonly>
            </div>
            ...
            <div>
              ...
              <div><input class="form-control Large input " name="title" readonly><span id="msgTitle"></span>
              </div>
            </div>
