    ...
    <form action="freeRegistForm" method="post" name="freeRegistForm" enctype="multipart/form-data">
      <div class="container">
        <div class="container-inner row">
         <input type="hidden" class="form-control " name="Category" value="free" readonly>          			
          <div class="innertitle col-md-3 col-sm-12">
            NAME
          </div>
          <div class="inner-control col-md-7 col-sm-12 ">
            <input class="form-control " name="Writer" value="${sessionScope.userVO.userId }" readonly>
          </div>
         ...
         <!-- 
                <i id="unlock" class="fas fa-lock-open" value="OFF" name="unlock" onclick="changeType()">공개글</i>
                <i id="lock" class="fa fa-unlock" value="ON" name="lock" onclick="changeType()" style="display: none;">비공개글</i>
          -->
                </div>
