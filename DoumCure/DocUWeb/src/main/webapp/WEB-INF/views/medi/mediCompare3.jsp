    ...
    <div class="row">
      <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4 right-line">
        <div>
          ...
          <h2 class="com-title-size medi-com-name">${vo1.proName }</h2>
        </div>
      ...
      <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4 right-line">
        <div>
          ...
          <h2 class="com-title-size medi-com-name">${vo2.proName }</h2>
        </div>
      ...
      <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4">
        <div>
          ...
          <h2 class="com-title-size medi-com-name">${vo3.proName }</h2>
        </div>
